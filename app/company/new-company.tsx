            ...
            <DialogContent className="sm:max-w-[700px] max-h-[90vh] overflow-y-auto">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <DialogFooter className="gap-2 sm:gap-0">
                        <Button type="button" className="h-11 mr-4 cursor-pointer" variant="outline" onClick={() => { setFormData(emptyForm()); onOpenChange(false); }}>Cancelar</Button>
                        <Button type="submit" className="h-11 cursor-pointer" disabled={loading}>{formData.id ? "Salvar Alterações" : "Criar Empresa"}</Button>
                    </DialogFooter>
                </form>
            </DialogContent>
        </Dialog>
